...
/// İlk yardım rehberi bölümleri: [başlık, içerik].
const List<List<String>> kFirstAid = [
  [
    'Temel Yaşam Desteği (TYD / Kalp masajı)',
    'Bilinci ve solunumu olmayan erişkinde: 30 göğüs basısı + 2 suni solunum '
        'döngüsü uygulanır. Bası hızı dakikada 100–120, derinlik yaklaşık 5 cm, '
        'göğsün ortasına. Profesyonel yardım gelene kadar kesintisiz sürdür.'
  ],
  [
    'Hava yolu tıkanıklığı (Heimlich)',
    'Tam tıkanmada (öksüremiyor, konuşamıyor): arkadan sarılıp göbek ile göğüs '
        'kemiği arasına içe-yukarı bası uygula. Kişi bilincini kaybederse hemen '
        'temel yaşam desteğine geç.'
  ],
  [
    'Koma (derlenme) pozisyonu',
    'Bilinci kapalı ama solunumu olan kişiyi yan yatır (derlenme/koma pozisyonu). '
        'Böylece dilin geriye kaçması ve boğulma önlenir; ağızdaki sıvı dışarı akar.'
  ],
  [
    'Dış kanama',
    'Kanayan bölgeye temiz bezle doğrudan baskı uygula ve bölgeyi kalp '
        'seviyesinin üstüne kaldır. Durmazsa baskı noktasına bas. Turnike yalnızca '
        'son çaredir.'
  ],
  [
    'Şok',
    'Kişiyi sırtüstü yatır, ayaklarını ~30 cm yukarı kaldır (bilinci açıksa). '
        'Üstünü ört, ısı kaybını önle; ağızdan bir şey verme.'
  ],
  [
    'Yanık',
    'Yanan bölgeyi 15–20 dk soğuk (buzsuz) su altında tut. Su toplamış '
        'kabarcıkları patlatma, üzerine bir şey sürme; temiz bezle ört.'
  ],
];
